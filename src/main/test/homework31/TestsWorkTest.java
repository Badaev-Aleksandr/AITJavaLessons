...
public class TestsWorkTest {
    ...
    @Test
    @DisplayName("6. Тест, который проверяет метод, возвращающий массив после его сортировки")
    void sortArrayTest() {
        int[] numbers = {5, 3, 6, 9, 7, 2};
        int[] sortNumbers = {2, 3, 5, 6, 7, 9};

         assertArrayEquals(String.valueOf(true),sortNumbers,testsWork.sortedArray(numbers));
